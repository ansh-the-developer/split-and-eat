...
export default function App() {
  ...
  //create a state for friends data
  const [friends, setNewFriends] = useState(initialFriends);
  //create current selected friend
  ...
  function handleSelection(friend) {
    setSelectedFriend((preValue) =>
      preValue?.id === friend?.id ? null : friend,
    );
    setShowAddFriend(false);
  }

  function handleAddNewFriends(newFriend) {
    setNewFriends([...friends, newFriend]);
    setShowAddFriend(false);
  }
  ...
  return (
    <div className="app">
      <div className="sidebar">
        ...
        {showAddFriend && <FormAddFriend onAddFriend={handleAddNewFriends} />}
...
function FormAddFriend({ onAddFriend }) {
  ...
  const [image, setImage] = useState("https://i.pravatar.cc/48?u=67");
  function handleOnSubmit(e) {
    ...
    setName("");
    setImage("https://i.pravatar.cc/48?u=67");
  }
  return (
